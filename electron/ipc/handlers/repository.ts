...
export function registerRepositoryHandlers(
  ...
  handle('repository:rhythm', (repoPath?: string) => repositoryService.getRepositoryRhythm(repoPath))
  handle('repository:contributorStats', (repoPath?: string) => repositoryService.getContributorStats(repoPath))
