...
export function buildRepositoryStarterPrompt(context: {
  ...
  return [
    ...
    '- gitignore is required and must be generated from detected languages, package managers, build outputs, caches, local env files, and editor/OS artifacts visible from the file list or metadata;',
    '- gitignore should be practical and compact: include detected tool patterns, avoid unrelated ecosystem templates, and do not include comments explaining every line;',
