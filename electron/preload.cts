...
const branchPilot: BranchPilotApi = {
  ...
  getGitBackendSettings: () => invoke('settings:getGitBackend'),
  setGitBackendSettings: (update) => invoke('settings:setGitBackend', update),
  getGitMonitorSettings: () => invoke('settings:getGitMonitor'),
  setGitMonitorSettings: (update) => invoke('settings:setGitMonitor', update),
