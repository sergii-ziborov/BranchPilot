...
export function AssistantPolicyPanel({
  ...
  const actions: AssistantActionKind[] = ['commit_message', 'branch_draft', 'pull_request_text', 'linkedin_project', 'repository_starter', 'file_beautify', 'review_report', 'codex_agent']
