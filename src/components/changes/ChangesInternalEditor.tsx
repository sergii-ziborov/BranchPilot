...
export function ChangesInternalEditor(props: ChangesInternalEditorProps) {
  ...
  const {
    ...
    codexAgentTextareaRef, codexAgentOpen, setCodexAgentOpen, codexAgentPrompt, setCodexAgentPrompt,
    setCodexAgentPromptFocused, codexAgentRunning, codexAgentResult, codexAgentError,
    codexAgentLiveEvents, codexAgentStopping, codexAgentStopped, stopCodexAgent, codexAgentAttachments,
    codexAgentPreviewAttachment, setCodexAgentPreviewAttachment, codexAgentProvider,
    codexAgentAssistant, setCodexAgentAssistant, codexAgentReasoning, setCodexAgentReasoning,
    codexAgentSandbox, setCodexAgentSandbox, codexAgentStatusLabel, codexAgentStatusMessage,
    codexAgentUsageText, codexAgentCommandSuggestions, selectLocalAgentProvider,
    addCodexAgentAttachments, handleCodexAgentPaste, handleCodexAgentDragOver, handleCodexAgentDrop,
    removeCodexAgentAttachment, applyCodexAgentCommand, runCodexAgentPanel,
    codexAgentQueue, codexAgentQueueCount, codexAgentQueuePaused, codexAgentQueuePauseReason,
    queueCurrentPrompt, removeCodexAgentQueueItem, clearCodexAgentQueue, moveCodexAgentQueueItem,
    pauseCodexAgentQueue, resumeCodexAgentQueue,
    agentSessionSummaryOpen, toggleAgentSessionSummary, refreshAgentSessionSummary,
    agentSessionSummary, agentSessionSummaryLoading, agentSessionSummaryError,
