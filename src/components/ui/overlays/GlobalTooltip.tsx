...
export function GlobalTooltip() {
  ...
  useEffect(() => {
    ...
    const reveal = (el: Element) => {
      ...
      // Keep the center-anchored bubble near its control while still fully on screen.
      const maxBubbleWidth = Math.min(280, Math.max(160, window.innerWidth - 24))
      const margin = maxBubbleWidth / 2 + 12
      ...
      const below = rect.bottom + 44 < window.innerHeight
